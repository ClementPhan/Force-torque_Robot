...
public:
  ...
  */
  void update(const Eigen::VectorXd& y, const Eigen::VectorXd& Fobj);

  /**
  * Update the estimated state based on measured values,
  * using the given time step and dynamics matrix.
  */
  void update(const Eigen::VectorXd& y, const Eigen::VectorXd& Fobj, double dt, const Eigen::MatrixXd A);
