MODULE Serveur
    ...
    VAR string OFFSET:="10"; !Valeurs du message par defaut
    ...
    VAR num speed:=500; !Vitesse du TCP (mm/s)

    CONST num resolution:=1; !Résolution max des obstacles (mm)

    VAR num buffer:=1; !Temps de buffer pour la correction (s)
