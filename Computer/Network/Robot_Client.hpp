...
// Robot state. Note that msgError indicates a badly formatted message, untreated by the robot while networkError is a non-treatable message recieved by this client.
