MODULE EGM_test_UDP
    ...
    ! in degees
    CONST robtarget p20:=[[34,-300,123],[0.000494947,0.662278052,-0.749217059,-0.007831731],[0,0,-1,0],[9E9,9E9,9E9,9E9,9E9,9E9]];

   PERS tooldata UISpenholder:=[TRUE,[[0,0,0],[1,0,0,0]],[0.001,[0,0,0.001],[1,0,0,0],0,0,0]];
    
    TASK PERS wobjdata wobjBordN:=[FALSE,TRUE,"",[[0,0,0],[1,0,0,0]],[[100,-200,8],[0.707106781,0,0,-0.707106781]]];
    
 VAR pose posecorTable:=[[100,-200,8],[1,0,0,0]];
    VAR pose posesenTable:=[[100,-200,8],[1,0,0,0]];
    ...
    PROC runEGM()
        EGMActPose egmID1\Tool:=UISpenholder\WObj:=wobj0,posecorTable,EGM_FRAME_WOBJ,posesenTable,EGM_FRAME_WOBJ
            ...
            \rx:=egm_minmax_rot1\ry:=egm_minmax_rot1\rz:=egm_minmax_rot1\LpFilter:=2\Samplerate:=4\MaxSpeedDeviation:=500;
